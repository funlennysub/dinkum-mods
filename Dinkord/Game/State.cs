...
public class State
{
    ...
    {
        return _networkMapSharer.localChar is null;
    }

    private bool IsUnderground()
    {
        return _realWorldTimeLight.underGround;
    }

    private Location WherePlayer()
    {
        return IsInMainMenu() ? Location.Menu : IsUnderground() ? Location.Mines : Location.Island;
    }
