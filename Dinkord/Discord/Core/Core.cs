...
public struct User
{
	...
	[MarshalAs(UnmanagedType.ByValTStr, SizeConst = 8)] public string Discriminator;

	[MarshalAs(UnmanagedType.ByValTStr, SizeConst = 128)] public string Avatar;
...
{
	[MarshalAs(UnmanagedType.ByValTStr, SizeConst = 128)] public string AccessToken;

	[MarshalAs(UnmanagedType.ByValTStr, SizeConst = 1024)] public string Scopes;
...
{
	[MarshalAs(UnmanagedType.ByValTStr, SizeConst = 128)] public string LargeImage;

	[MarshalAs(UnmanagedType.ByValTStr, SizeConst = 128)] public string LargeText;

	[MarshalAs(UnmanagedType.ByValTStr, SizeConst = 128)] public string SmallImage;

	[MarshalAs(UnmanagedType.ByValTStr, SizeConst = 128)] public string SmallText;
}
...
{
	[MarshalAs(UnmanagedType.ByValTStr, SizeConst = 128)] public string Match;

	[MarshalAs(UnmanagedType.ByValTStr, SizeConst = 128)] public string Join;

	[MarshalAs(UnmanagedType.ByValTStr, SizeConst = 128)] public string Spectate;
}
...
public struct Activity
{
	...
	[MarshalAs(UnmanagedType.ByValTStr, SizeConst = 128)] public string State;

	[MarshalAs(UnmanagedType.ByValTStr, SizeConst = 128)] public string Details;
...
public struct Lobby
{
	...
	[MarshalAs(UnmanagedType.ByValTStr, SizeConst = 128)] public string Secret;
...
public struct SkuPrice
{
	...
	[MarshalAs(UnmanagedType.ByValTStr, SizeConst = 16)] public string Currency;
}
...
public struct InputMode
{
	...
	[MarshalAs(UnmanagedType.ByValTStr, SizeConst = 256)] public string Shortcut;
}
...
public struct UserAchievement
{
	...
	[MarshalAs(UnmanagedType.ByValTStr, SizeConst = 64)] public string UnlockedAt;
}
...
public struct LobbySearchQuery
{
	...
	{
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		internal delegate Result FilterMethod(IntPtr methodsPtr, [MarshalAs(UnmanagedType.LPStr)] string key, LobbySearchComparison comparison,
			LobbySearchCast cast, [MarshalAs(UnmanagedType.LPStr)] string value);

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		internal delegate Result SortMethod(IntPtr methodsPtr, [MarshalAs(UnmanagedType.LPStr)] string key, LobbySearchCast cast,
			[MarshalAs(UnmanagedType.LPStr)] string value);
...
public partial class ActivityManager
{
	...
	private static void OnActivityJoinImpl(IntPtr ptr, string secret)
	{
		var h = GCHandle.FromIntPtr(ptr);
		var d = (Discord)h.Target;
		if (d.ActivityManagerInstance.OnActivityJoin != null) d.ActivityManagerInstance.OnActivityJoin.Invoke(secret);
	}
	...
	private static void OnActivitySpectateImpl(IntPtr ptr, string secret)
	{
		var h = GCHandle.FromIntPtr(ptr);
		var d = (Discord)h.Target;
		if (d.ActivityManagerInstance.OnActivitySpectate != null) d.ActivityManagerInstance.OnActivitySpectate.Invoke(secret);
	}
	...
	private static void OnActivityJoinRequestImpl(IntPtr ptr, ref User user)
	{
		var h = GCHandle.FromIntPtr(ptr);
		var d = (Discord)h.Target;
		if (d.ActivityManagerInstance.OnActivityJoinRequest != null) d.ActivityManagerInstance.OnActivityJoinRequest.Invoke(ref user);
	}
	...
	private static void OnActivityInviteImpl(IntPtr ptr, ActivityActionType type, ref User user, ref Activity activity)
	{
		var h = GCHandle.FromIntPtr(ptr);
		var d = (Discord)h.Target;
		if (d.ActivityManagerInstance.OnActivityInvite != null) d.ActivityManagerInstance.OnActivityInvite.Invoke(type, ref user, ref activity);
	}
	...
	internal struct FFIMethods
	{
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		internal delegate void SendRequestReplyMethod(IntPtr methodsPtr, long userId, ActivityJoinRequestReply reply, IntPtr callbackData,
		...
		internal delegate void SendInviteMethod(IntPtr methodsPtr, long userId, ActivityActionType type,
			...
			IntPtr callbackData, SendInviteCallback callback);
...
public class RelationshipManager
{
	...
	private static void OnRelationshipUpdateImpl(IntPtr ptr, ref Relationship relationship)
	{
		var h = GCHandle.FromIntPtr(ptr);
		var d = (Discord)h.Target;
		if (d.RelationshipManagerInstance.OnRelationshipUpdate != null) d.RelationshipManagerInstance.OnRelationshipUpdate.Invoke(ref relationship);
	}
...
public partial class LobbyManager
{
	...
	private static void OnLobbyDeleteImpl(IntPtr ptr, long lobbyId, uint reason)
	{
		var h = GCHandle.FromIntPtr(ptr);
		var d = (Discord)h.Target;
		if (d.LobbyManagerInstance.OnLobbyDelete != null) d.LobbyManagerInstance.OnLobbyDelete.Invoke(lobbyId, reason);
	}
	...
	private static void OnMemberConnectImpl(IntPtr ptr, long lobbyId, long userId)
	{
		var h = GCHandle.FromIntPtr(ptr);
		var d = (Discord)h.Target;
		if (d.LobbyManagerInstance.OnMemberConnect != null) d.LobbyManagerInstance.OnMemberConnect.Invoke(lobbyId, userId);
	}
	...
	private static void OnMemberUpdateImpl(IntPtr ptr, long lobbyId, long userId)
	{
		var h = GCHandle.FromIntPtr(ptr);
		var d = (Discord)h.Target;
		if (d.LobbyManagerInstance.OnMemberUpdate != null) d.LobbyManagerInstance.OnMemberUpdate.Invoke(lobbyId, userId);
	}
	...
	private static void OnMemberDisconnectImpl(IntPtr ptr, long lobbyId, long userId)
	{
		var h = GCHandle.FromIntPtr(ptr);
		var d = (Discord)h.Target;
		if (d.LobbyManagerInstance.OnMemberDisconnect != null) d.LobbyManagerInstance.OnMemberDisconnect.Invoke(lobbyId, userId);
	}
	...
	private static void OnSpeakingImpl(IntPtr ptr, long lobbyId, long userId, bool speaking)
	{
		var h = GCHandle.FromIntPtr(ptr);
		var d = (Discord)h.Target;
		if (d.LobbyManagerInstance.OnSpeaking != null) d.LobbyManagerInstance.OnSpeaking.Invoke(lobbyId, userId, speaking);
	}
	...
	internal struct FFIMethods
	{
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		internal delegate void ConnectLobbyMethod(IntPtr methodsPtr, long lobbyId, [MarshalAs(UnmanagedType.LPStr)] string secret,
			IntPtr callbackData,
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		internal delegate void ConnectLobbyWithActivitySecretMethod(IntPtr methodsPtr, [MarshalAs(UnmanagedType.LPStr)] string activitySecret,
			IntPtr callbackData, ConnectLobbyWithActivitySecretCallback callback);
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		internal delegate Result GetLobbyMetadataValueMethod(IntPtr methodsPtr, long lobbyId, [MarshalAs(UnmanagedType.LPStr)] string key,
			StringBuilder value);
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		internal delegate void UpdateMemberMethod(IntPtr methodsPtr, long lobbyId, long userId, IntPtr transaction, IntPtr callbackData,
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		internal delegate void SendLobbyMessageMethod(IntPtr methodsPtr, long lobbyId, byte[] data, int dataLen, IntPtr callbackData,
...
public class NetworkManager
{
	...
	private static void OnRouteUpdateImpl(IntPtr ptr, string routeData)
	{
		var h = GCHandle.FromIntPtr(ptr);
		var d = (Discord)h.Target;
		if (d.NetworkManagerInstance.OnRouteUpdate != null) d.NetworkManagerInstance.OnRouteUpdate.Invoke(routeData);
	}
...
public class OverlayManager
{
	...
	internal struct FFIMethods
	{
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		internal delegate void OpenGuildInviteMethod(IntPtr methodsPtr, [MarshalAs(UnmanagedType.LPStr)] string code, IntPtr callbackData,
...
public partial class StorageManager
{
	...
	internal struct FFIMethods
	{
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		internal delegate void ReadAsyncMethod(IntPtr methodsPtr, [MarshalAs(UnmanagedType.LPStr)] string name, IntPtr callbackData,
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		internal delegate void ReadAsyncPartialMethod(IntPtr methodsPtr, [MarshalAs(UnmanagedType.LPStr)] string name, ulong offset, ulong length,
			IntPtr callbackData, ReadAsyncPartialCallback callback);
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		internal delegate void WriteAsyncMethod(IntPtr methodsPtr, [MarshalAs(UnmanagedType.LPStr)] string name, byte[] data, int dataLen,
			IntPtr callbackData, WriteAsyncCallback callback);
...
public partial class StoreManager
{
	...
	private static void OnEntitlementCreateImpl(IntPtr ptr, ref Entitlement entitlement)
	{
		var h = GCHandle.FromIntPtr(ptr);
		var d = (Discord)h.Target;
		if (d.StoreManagerInstance.OnEntitlementCreate != null) d.StoreManagerInstance.OnEntitlementCreate.Invoke(ref entitlement);
	}
	...
	private static void OnEntitlementDeleteImpl(IntPtr ptr, ref Entitlement entitlement)
	{
		var h = GCHandle.FromIntPtr(ptr);
		var d = (Discord)h.Target;
		if (d.StoreManagerInstance.OnEntitlementDelete != null) d.StoreManagerInstance.OnEntitlementDelete.Invoke(ref entitlement);
	}
...
public class AchievementManager
{
	...
	internal struct FFIMethods
	{
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		internal delegate void SetUserAchievementMethod(IntPtr methodsPtr, long achievementId, byte percentComplete, IntPtr callbackData,
